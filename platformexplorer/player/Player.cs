...
public partial class Player : Node2D
{
    ...
    private float _remoteAttackMoveSpeed = 32 * 0.2f;       // 近战攻击移动速度
    //Input-Related
    ...
    public override void _Ready()
    {
        ...
        _playerRemoteAttackState.AddEnter(() => _isAttack = true).AddEnter(() => _attackIndex = 2).
            AddTransitions(() => !_isAttack, _playerIdleState).
            AddPhysicsProcess((delta) => SetVelocity(_playerInput.Horizontal * _remoteAttackMoveSpeed, _playerInput.Vertical * _remoteAttackMoveSpeed));
